#!/usr/bin/env python3
"""
1-Year Backtest - SPX - REALISTIC 0DTE with 7 ENTRY TIMES
...
print("=" * 80)
print("1-YEAR BACKTEST - SPX - 7 ENTRY TIMES + HALF-KELLY AUTOSCALING")
print("=" * 80)
print()
...
for day_num in range(num_days):
    ...
    for entry_label, entry_hour in ENTRY_TIMES:
        ...
        distance_otm = distance + 20

        # Get realistic credit
        credit = get_realistic_spx_credit(vix, distance_otm, entry_hour)
...
print()
print("=" * 80)
print("SPX 7-ENTRY BACKTEST COMPLETE")
print("=" * 80)
